      ...
      <div className="max-w-4xl mx-auto">
        ...
        {projects.some(p => p.archived) && (
          <div className="flex justify-end mb-2">
            ...
            >
              {showArchived ? '隐藏已归档项目' : `显示已归档项目（${projects.filter(p => p.archived).length}）`}
            </button>
          </div>
        )}
              ...
              <CardContent className="p-4">
                <div className="flex flex-col sm:flex-row sm:items-center gap-3">
                  ...
                  <div className="flex items-center justify-between sm:justify-end gap-3 pl-13 sm:pl-0">
                    ...
                    {project.archived && (
                      <Badge variant="outline" className="text-[10px] text-neutral-400 dark:text-neutral-500 border-neutral-300 dark:border-neutral-600 shrink-0">已归档</Badge>
                    )}
                  </div>
                </div>
              </CardContent>
            ...
            <Card>
              <CardContent className="py-12">
                <div className="text-center text-neutral-500 dark:text-neutral-400">
                  ...
                  <p className="text-lg font-medium dark:text-neutral-300">还没有配置项目</p>
                  <p className="text-sm mt-2">先添加一个项目开始使用</p>
                </div>
              </CardContent>
            </Card>
          )}
